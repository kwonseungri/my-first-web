...
GitHub Copilot을 설치하고 copilot-instructions.md를 작성할 수 있다

블로그 소개 페이지를 생성·검증·배포할 수 있다
...
AI는 과거 데이터로 학습한다. **npx create-next-app@latest**

로 최신 버전이 설치되지만, AI는 구버전 문법을 제안한다.
...
[github.com/settings/copilot](https://github.com/settings/copilot) 접속

**"Get access to GitHub Copilot"** 클릭하여 활성화
...
는 Copilot이 **매 세션마다 자동으로 읽는** 프로젝트 지시 파일이다. 컨텍스트 문제의 80%를 해결한다.
...
> ".github/copilot-instructions.md의 Known AI Mistakes에 추가해줘: **class**
>
> 금지 → **className**
>
> 사용"
...
생성된 파일을 열어 **package.json**

의 실제 버전과 일치하는지 확인한다.

틀리면 Copilot에게 수정 지시 후 저장한다.
...
**npm run dev**
 ...
 → [localhost:3000](http://localhost:3000/)에서 확인한다.
...
> **Antigravity 사용자**: Copilot 승인 대기 중이라면 [antigravity.google](https://antigravity.google/)에서 다운로드. VS Code 포크 IDE로, **.edu**
>
> 이메일이면 Starter 플랜 무료. 자동완성, Agent Panel, MCP 기본 내장.
