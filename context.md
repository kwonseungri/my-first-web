...
- **완료된 작업**: 
  ...
  - Ch11 RLS 보안 고도화 완료 (profiles/posts 정책, 댓글/스토리지 연동, service_role 검증)
  - Ch12 에러 처리 및 로딩 UX 구현 완료 (loading.tsx, error.tsx, 폼 클라이언트 검증 로직 적용)
  - Playwright E2E 테스트 스크립트 작성 완료 (테스트 환경변수 주입 후 검증 필요)
- **진행 중**: 없음
- **미착수**: Vercel 배포 도메인 수동 검증
